...
- Explanation
  <p>Kita diberikan sebuah file for_that_special_someone, dan jika dibuka ada sebuah code assembly</p>
```
   0           RESUME                   0
...
Disassembly of <code object main at 0x7f1670d856f0, file "chall.py", line 86>:
 ...
 91           LOAD_CONST               1 ('Rose Cyclamen Crocus Daisy Orchid Bluebell Gardenia Jasmine Nerine Cyclamen Freesia Peony Snapdragon Buttercup Snapdragon Orchid Verbena Cyclamen Azalea Peony Primula Cyclamen Jasmine Cyclamen Crocus Daisy Orchid Bluebell Gardenia Jasmine Nerine Cyclamen Crocus Peony Aster Orchid Peony Xeranthemum Orchid Ixora Cyclamen Violet Magnolia Kalmia Canna Bluebell Viola Orchid Crocus Verbena Thistle Nerine Jasmine Thistle Cosmos Gardenia Orchid Thistle Orchid Xeranthemum Thistle Primula Peony Crocus Orchid Silene')
              ...
              RETURN_CONST             0 (None)
```
<p>Program ini menyimpan sekumpulan konstanta di memori stack, kemudian setiap byte dari konstanta tersebut dibaca dalam urutan little-endian dan di-XOR dengan nilai kunci 0x5e. Hasil XOR membentuk string yang menjadi target pembanding dengan input dari pengguna. Selama eksekusi, program men-null-terminate hasil tersebut lalu membandingkannya karakter demi karakter dengan argumen yang diberikan. Jika ada perbedaan maka program langsung mencetak “Wrong!” dan keluar, sedangkan jika seluruh karakter cocok maka program mencetak pesan sukses. Dengan cara ini dapat diketahui bahwa string hasil XOR itulah flag sebenarnya, dan setelah diekstrak diperoleh flag</p>
